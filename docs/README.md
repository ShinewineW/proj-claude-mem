...
- `reference/session-id-architecture.md`
...
### 报告（Reports，时间点产物）
- `reports/2026-01-10-bugfix-sprint.md` — 早期 bugfix sprint 任务清单（旧文档，无元数据头）。
...
- `spec/Manual/2026-06-09-plugin-independence-goals.md` — 插件独立化目标（状态：草案；脱离 claude-mem 身份、独立版本线与分发模式）。

## 3. Cross-Ref

- 根 [`README.md`](../README.md) — 项目总览；其「致谢」段链接 `reference/provenance.md`。
