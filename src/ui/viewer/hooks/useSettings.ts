    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        ...
        setSettings({
          ...
          CLAUDE_MEM_OPENCODE_API_KEY: data.CLAUDE_MEM_OPENCODE_API_KEY ?? DEFAULT_SETTINGS.CLAUDE_MEM_OPENCODE_API_KEY,
          CLAUDE_MEM_OPENCODE_MODEL: data.CLAUDE_MEM_OPENCODE_MODEL ?? DEFAULT_SETTINGS.CLAUDE_MEM_OPENCODE_MODEL,
