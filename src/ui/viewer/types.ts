...
export interface Settings {
  ...
  CLAUDE_MEM_BYPASS_COOLDOWN_MS?: string;
  CLAUDE_MEM_BYPASS_QUOTA_COOLDOWN_MS?: string;
  CLAUDE_MEM_BYPASS_AUTH_COOLDOWN_MS?: string;
  CLAUDE_MEM_BYPASS_MAX_FAILURES?: string;
  CLAUDE_MEM_BYPASS_CONCURRENCY?: string;
  CLAUDE_MEM_BYPASS_MAX_CONSUMERS?: string;
