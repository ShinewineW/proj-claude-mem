...
If the user wants a single sweeping report, use `mem-timeline` instead. This skill is for serial chapter format.
...
Same worktree-detection pattern as `mem-timeline`. In a worktree, the data source is the **parent project**:
