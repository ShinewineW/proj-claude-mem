...
bun test ./tests/         # Run the fork's own tests (2186 pass, 0 fail; 236 files, 2026-07-28). Scope to ./tests/ — a bare `bun test` at root also scans the upstream clone in attn_sink/ (~52 unrelated failures).
```
