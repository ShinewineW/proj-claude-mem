...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=p?`${p[1].split("/").pop()}:${p[2]}`:"unknown",u={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,u,n),o}},_=new Y;var It={};function Ct(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,pe.fileURLToPath)(It.url))}var At=Ct(),A=process.env.CLAUDE_MEM_DATA_DIR||I.get("CLAUDE_MEM_DATA_DIR"),y=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,ce.homedir)(),".claude"),Jt=(0,b.join)(y,"plugins","marketplaces","thedotmack"),Qt=(0,b.join)(A,"archives"),zt=(0,b.join)(A,"logs"),Zt=(0,b.join)(A,"trash"),es=(0,b.join)(A,"backups"),ts=(0,b.join)(A,"modes"),ss=(0,b.join)(A,"settings.json"),_e=(0,b.join)(A,"claude-mem.db"),rs=(0,b.join)(A,"vector-db"),ns=(0,b.join)(A,"observer-sessions"),os=(0,b.join)(y,"settings.json"),is=(0,b.join)(y,"commands"),as=(0,b.join)(y,"CLAUDE.md");function me(r){(0,F.mkdirSync)(r,{recursive:!0})}function ue(){return(0,b.join)(At,"..")}var le=require("crypto");var yt=3e4;function Ee(r,e,t){return(0,le.createHash)("sha256").update((r||"")+(e||"")+(t||"")).digest("hex").slice(0,16)}function Te(r,e,t){let s=t-yt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}var D=class{db;constructor(e=_e){e!==":memory:"&&me((0,fe.dirname)(e)),this.db=new ge.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn()}initializeSchema(){this.db.run(`
  ...
  `).all(...e,...s,...o,t.totalObservationCount)}function Ae(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(...e,t.sessionCount+q)}function vt(r){return r.replace(/\//g,"-")}function Mt(r){try{if(!(0,j.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,j.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
