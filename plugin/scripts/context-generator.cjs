...
`+JSON.stringify(o,null,2):m=" "+this.formatData(o));let u="";if(n){let{sessionId:E,memorySessionId:g,correlationId:h,...l}=n;Object.keys(l).length>0&&(u=` {${Object.entries(l).map(([f,R])=>`${f}=${R}`).join(", ")}}`)}let T=`[${i}] [${a}] [${c}] ${p}${s}${u}${m}`;if(this.logFilePath)try{(0,C.appendFileSync)(this.logFilePath,T+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=p?`${p[1].split("/").pop()}:${p[2]}`:"unknown",u={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,u,n),o}},_=new W;var It={};function Ct(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,pe.fileURLToPath)(It.url))}var At=Ct(),A=I.get("CLAUDE_MEM_DATA_DIR"),y=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,ce.homedir)(),".claude"),Qt=(0,b.join)(y,"plugins","marketplaces","thedotmack"),zt=(0,b.join)(A,"archives"),Zt=(0,b.join)(A,"logs"),es=(0,b.join)(A,"trash"),ts=(0,b.join)(A,"backups"),ss=(0,b.join)(A,"modes"),rs=(0,b.join)(A,"settings.json"),_e=(0,b.join)(A,"claude-mem.db"),ns=(0,b.join)(A,"vector-db"),os=(0,b.join)(A,"observer-sessions"),is=(0,b.join)(y,"settings.json"),as=(0,b.join)(y,"commands"),ds=(0,b.join)(y,"CLAUDE.md");function me(r){(0,Y.mkdirSync)(r,{recursive:!0})}function ue(){return(0,b.join)(At,"..")}var le=require("crypto");var yt=3e4;function Ee(r,e,t){return(0,le.createHash)("sha256").update((r||"")+(e||"")+(t||"")).digest("hex").slice(0,16)}function Te(r,e,t){let s=t-yt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}var D=class{db;constructor(e=_e){e!==":memory:"&&me((0,fe.dirname)(e)),this.db=new ge.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn()}initializeSchema(){this.db.run(`
  ...
  `).all(...e,...s,...o,t.totalObservationCount)}function Ae(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(...e,t.sessionCount+q)}function vt(r){return r.replace(/\//g,"-")}function Mt(r){try{if(!(0,X.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,X.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim()),s="";for(let n=t.length-1;n>=0;n--)try{let o=t[n];if(!o.includes('"type":"assistant"'))continue;let i=JSON.parse(o);if(i.type==="assistant"&&i.message?.content&&Array.isArray(i.message.content)){let a="";for(let c of i.message.content)c.type==="text"&&(a+=c.text);if(a=a.replace(/<system-reminder>[\s\S]*?<\/system-reminder>/g,"").trim(),a){s=a;break}}}catch(o){_.debug("PARSER","Skipping malformed transcript line",{lineIndex:n},o);continue}return{userMessage:"",assistantMessage:s}}catch(e){return _.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e),{userMessage:"",assistantMessage:""}}}function Z(r,e,t,s){if(!e.showLastMessage||r.length===0)return{userMessage:"",assistantMessage:""};let n=r.find(c=>c.memory_session_id!==t);if(!n)return{userMessage:"",assistantMessage:""};let o=n.memory_session_id,i=vt(s),a=Ne.default.join(y,"projects",i,`${o}.jsonl`);return Mt(a)}function Ie(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function ee(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function ye(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function Le(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function ve(r){return[`# [${r}] recent context, ${Le()}`,""]}function Me(){return[`**Legend:** session-request | ${O.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ")}`,""]}function De(){return["**Column Key**:","- **Read**: Tokens to read this observation (cost to learn it now)","- **Work**: Tokens spent on work that produced this record ( research, building, deciding)",""]}function xe(){return["**Context Index:** This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.","","When you need implementation details, rationale, or debugging context:","- Fetch by ID: get_observations([IDs]) for observations visible in this index","- Search history: Use the mem-search skill for past decisions, bugs, and deeper research","- Trust this index over re-reading code for past decisions and learnings",""]}function Ue(r,e){let t=[];if(t.push("**Context Economics**:"),t.push(`- Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)`),t.push(`- Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="- Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(s)}return t.push(""),t}function ke(r){return[`### ${r}`,""]}function we(r){return[`**${r}**`,"| ID | Time | T | Title | Read | Work |","|----|------|---|-------|------|------|"]}function $e(r,e,t){let s=r.title||"Untitled",n=O.getInstance().getTypeIcon(r.type),{readTokens:o,discoveryDisplay:i}=L(r,t),a=t.showReadTokens?`~${o}`:"",c=t.showWorkTokens?i:"";return`| #${r.id} | ${e||'"'} | ${n} | ${s} | ${a} | ${c} |`}function Fe(r,e,t,s){let n=[],o=r.title||"Untitled",i=O.getInstance().getTypeIcon(r.type),{readTokens:a,discoveryDisplay:c}=L(r,s);n.push(`**#${r.id}** ${e||'"'} ${i} **${o}**`),t&&(n.push(""),n.push(t),n.push(""));let p=[];return s.showReadTokens&&p.push(`Read: ~${a}`),s.showWorkTokens&&p.push(`Work: ${c}`),p.length>0&&n.push(p.join(", ")),n.push(""),n}function Pe(r,e){let t=`${r.request||"Session started"} (${e})`;return[`**#S${r.id}** ${t}`,""]}function U(r,e){return e?[`**${r}**: ${e}`,""]:[]}function Xe(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function je(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the claude-mem skill to access memories by ID.`]}function Ge(r){return`# [${r}] recent context, ${Le()}

No previous sessions found for this project yet.`}function He(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Be(r){return["",`${d.bright}${d.cyan}[${r}] recent context, ${He()}${d.reset}`,`${d.gray}${"\u2500".repeat(60)}${d.reset}`,""]}function We(){let e=O.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${d.dim}Legend: session-request | ${e}${d.reset}`,""]}function Ye(){return[`${d.bright}Column Key${d.reset}`,`${d.dim}  Read: Tokens to read this observation (cost to learn it now)${d.reset}`,`${d.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${d.reset}`,""]}function Ve(){return[`${d.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${d.reset}`,"",`${d.dim}When you need implementation details, rationale, or debugging context:${d.reset}`,`${d.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${d.reset}`,`${d.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${d.reset}`,`${d.dim}  - Trust this index over re-reading code for past decisions and learnings${d.reset}`,""]}function qe(r,e){let t=[];if(t.push(`${d.bright}${d.cyan}Context Economics${d.reset}`),t.push(`${d.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${d.reset}`),t.push(`${d.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${d.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(`${d.green}${s}${d.reset}`)}return t.push(""),t}function Ke(r){return[`${d.bright}${d.cyan}${r}${d.reset}`,""]}function Je(r){return[`${d.dim}${r}${d.reset}`]}function Qe(r,e,t,s){let n=r.title||"Untitled",o=O.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:c}=L(r,s),p=t?`${d.dim}${e}${d.reset}`:" ".repeat(e.length),m=s.showReadTokens&&i>0?`${d.dim}(~${i}t)${d.reset}`:"",u=s.showWorkTokens&&a>0?`${d.dim}(${c} ${a.toLocaleString()}t)${d.reset}`:"";return`  ${d.dim}#${r.id}${d.reset}  ${p}  ${o}  ${n} ${m} ${u}`}function ze(r,e,t,s,n){let o=[],i=r.title||"Untitled",a=O.getInstance().getTypeIcon(r.type),{readTokens:c,discoveryTokens:p,workEmoji:m}=L(r,n),u=t?`${d.dim}${e}${d.reset}`:" ".repeat(e.length),T=n.showReadTokens&&c>0?`${d.dim}(~${c}t)${d.reset}`:"",E=n.showWorkTokens&&p>0?`${d.dim}(${m} ${p.toLocaleString()}t)${d.reset}`:"";return o.push(`  ${d.dim}#${r.id}${d.reset}  ${u}  ${a}  ${d.bright}${i}${d.reset}`),s&&o.push(`    ${d.dim}${s}${d.reset}`),(T||E)&&o.push(`    ${T} ${E}`),o.push(""),o}function Ze(r,e){let t=`${r.request||"Session started"} (${e})`;return[`${d.yellow}#S${r.id}${d.reset} ${t}`,""]}function k(r,e,t){return e?[`${t}${r}:${d.reset} ${e}`,""]:[]}function et(r){return r.assistantMessage?["","---","",`${d.bright}${d.magenta}Previously${d.reset}`,"",`${d.dim}A: ${r.assistantMessage}${d.reset}`,""]:[]}function tt(r,e){let t=Math.round(r/1e3);return["",`${d.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the claude-mem skill to access memories by ID.${d.reset}`]}function st(r){return`
${d.bright}${d.cyan}[${r}] recent context, ${He()}${d.reset}
${d.gray}${"\u2500".repeat(60)}${d.reset}

${d.dim}No previous sessions found for this project yet.${d.reset}
`}function rt(r,e,t,s){let n=[];return s?n.push(...Be(r)):n.push(...ve(r)),s?n.push(...We()):n.push(...Me()),s?n.push(...Ye()):n.push(...De()),s?n.push(...Ve()):n.push(...xe()),P(t)&&(s?n.push(...qe(e,t)):n.push(...Ue(e,t))),n}var te=v(require("path"),1);function H(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return _.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function ot(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function it(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function at(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function nt(r,e){return te.default.isAbsolute(r)?te.default.relative(e,r):r}function dt(r,e,t){let s=H(r);if(s.length>0)return nt(s[0],e);if(t){let n=H(t);if(n.length>0)return nt(n[0],e)}return"General"}function Dt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=at(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function xt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?H(r.facts).join(`
`):null}function Ut(r,e,t,s,n,o){let i=[];o?i.push(...Ke(r)):i.push(...ke(r));let a=null,c="",p=!1;for(let m of e)if(m.type==="summary"){p&&(i.push(""),p=!1,a=null,c="");let u=m.data,T=ot(u.displayTime);o?i.push(...Ze(u,T)):i.push(...Pe(u,T))}else{let u=m.data,T=dt(u.files_modified,n,u.files_read),E=it(u.created_at),g=E!==c,h=g?E:"";c=E;let l=t.has(u.id);if(T!==a&&(p&&i.push(""),o?i.push(...Je(T)):i.push(...we(T)),a=T,p=!0),l){let S=xt(u,s);o?i.push(...ze(u,E,g,S,s)):(p&&!o&&(i.push(""),p=!1),i.push(...Fe(u,h,S,s)),a=null)}else o?i.push(Qe(u,E,g,s)):i.push($e(u,h,s))}return p&&i.push(""),i}function ct(r,e,t,s,n){let o=[],i=Dt(r);for(let[a,c]of i)o.push(...Ut(a,c,e,t,s,n));return o}function pt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function _t(r,e){let t=[];return e?(t.push(...k("Investigated",r.investigated,d.blue)),t.push(...k("Learned",r.learned,d.yellow)),t.push(...k("Completed",r.completed,d.green)),t.push(...k("Next Steps",r.next_steps,d.magenta))):(t.push(...U("Investigated",r.investigated)),t.push(...U("Learned",r.learned)),t.push(...U("Completed",r.completed)),t.push(...U("Next Steps",r.next_steps))),t}function mt(r,e){return e?et(r):Xe(r)}function ut(r,e,t){return!P(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?tt(r.totalDiscoveryTokens,r.totalReadTokens):je(r.totalDiscoveryTokens,r.totalReadTokens)}var kt=lt.default.join((0,Et.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function wt(r){try{return r?new D(r):new D}catch(e){if(e.code==="ERR_DLOPEN_FAILED"){try{(0,Tt.unlinkSync)(kt)}catch(t){_.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},t)}return _.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw e}}function $t(r,e){return e?st(r):Ge(r)}function Ft(r,e,t,s,n,o,i){let a=[],c=J(e);a.push(...rt(r,c,s,i));let p=t.slice(0,s.sessionCount),m=Ie(p,t),u=ee(e,m),T=ye(e,s.fullObservationCount);a.push(...ct(u,T,s,n,i));let E=t[0],g=e[0];pt(s,E,g)&&a.push(..._t(E,i));let h=Z(e,s,o,n);return a.push(...mt(h,i)),a.push(...ut(c,s,i)),a.join(`
`).trimEnd()}async function se(r,e=!1){let t=V(),s=r?.cwd??process.cwd(),n=be(s),o=r?.projects||[n],i=wt(r?.dbPath);if(!i)return"";try{let a=o.length>1?Ce(i,o,t):Q(i,n,t),c=o.length>1?Ae(i,o,t):z(i,n,t);return a.length===0&&c.length===0?$t(n,e):Ft(n,a,c,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
